    ...
    <section className="relative min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-10 overflow-hidden bg-pb-bg">
      ...
      <div className="w-full max-w-[440px] rounded-xl border border-pb-border bg-white shadow-xl">
        <div className="p-8 md:p-10">
          ...
          {status === "success" ? (
            <div className="rounded-lg border border-pb-border bg-pb-surface p-5">
              <p className="text-pb-text font-semibold">{t("auth.forgot.checkEmail")}</p>
              ...
              <div className="mt-5 flex flex-col gap-3">
                <Link
                  to="/reset-password"
                  className="w-full text-center rounded-lg bg-pb-primary py-3 font-bold text-white hover:bg-pb-primary-hover transition-colors"
                >
                ...
                <Link
                  to="/login"
                  className="w-full text-center rounded-lg border border-pb-border py-3 text-sm font-semibold text-pb-text hover:bg-slate-50 transition-colors"
                >
            ...
            <form onSubmit={onSubmit} className="space-y-6">
              <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-pb-text-secondary group-focus-within:text-pb-primary transition-colors">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-pb-border bg-white py-3 pl-11 pr-4 text-pb-text placeholder:text-slate-400 outline-none transition-all focus:ring-2 focus:ring-pb-primary/20 focus:border-pb-primary"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={!canSubmit}
                className="w-full rounded-lg bg-pb-primary py-4 font-bold text-white shadow-md transition-all hover:bg-pb-primary-hover disabled:opacity-50 disabled:cursor-not-allowed"
              >
