...
export function ReturnsPage() {
  ...
  const supportHref = buildWhatsAppLink({
    ...
    message: t("support.common.whatsappMessageReturns"),
  });
    ...
    <main className="mx-auto max-w-5xl px-4 py-10">
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 md:p-8">
        ...
        <div className="mt-8 space-y-6">
          ...
          <Section title={t("support.returns.sections.exclusionsTitle")} text={t("support.returns.sections.exclusionsText")} />
